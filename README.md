...
- runs an end-to-end processing pipeline from the GUI:
  ...
  - optionally launches Metashape through a configured executable to build an orthomosaic
...
├── metashape_reference.csv   # generated only when Metashape runs
├── metashape_script.py       # generated only when Metashape runs
├── metashape_project.psx     # generated by Metashape
└── orthomosaic.tif           # generated by Metashape
```
